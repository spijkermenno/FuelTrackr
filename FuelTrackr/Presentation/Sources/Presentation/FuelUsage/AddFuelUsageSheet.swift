...
public struct AddFuelUsageSheet: View {
    @InjectedObject public var vehicleViewModel: VehicleViewModel
    @InjectedObject public var viewModel: AddFuelUsageViewModel

    @Environment(\.dismiss) public var dismiss
    @State public var keyboardHeight: CGFloat = 0

    public init() {} // All dependencies are injected
