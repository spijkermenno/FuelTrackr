...
public struct CompactTripOverviewCard: View {
    ...
    private var kmDriven: Int {
        viewModel.kmDriven(forMonth: selectedMonth, year: selectedYear, context: context)
    }

    private var fuelUsed: Double {
        viewModel.fuelUsed(forMonth: selectedMonth, year: selectedYear, context: context)
    }

    private var fuelCost: Double {
        viewModel.fuelCost(forMonth: selectedMonth, year: selectedYear, context: context)
    }

    private var avgFuelUsage: Double {
        viewModel.averageFuelUsage(forMonth: selectedMonth, year: selectedYear, context: context)
    }
